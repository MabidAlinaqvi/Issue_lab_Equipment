...
public class t_account_adapter extends ArrayAdapter {
ArrayList list=new ArrayList();

    public t_account_adapter(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row==null)
        {
            ...
            row=inflater.inflate(R.layout.t_accountrow_layout,parent,false);
            handler=new DataHandler();
            handler.nam=row.findViewById(R.id.user_nam);
        ...
        t_accountdataProvider dataProvider;
        dataProvider=(t_accountdataProvider)this.getItem(position);
        handler.nam.setText(dataProvider.getS_name());
